...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate {
    ...
    // MARK: - URL Scheme Handling (miaou://notify?session=xxx)
    ...
    func handleIncomingURL(_ url: URL) {
        guard url.scheme == "miaou" else { return }
    ...
    @objc private func updateStatusBarIcon() {
        ...
        button.image = NSImage(systemSymbolName: "cat.fill", accessibilityDescription: "Miaou")
    }
